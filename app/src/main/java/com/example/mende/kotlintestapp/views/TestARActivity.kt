...
import com.example.mende.kotlintestapp.util.PointCloudNode
...
class TestARActivity : AppCompatActivity() {

    private val TAG = "Testing AR"
       ...
       // arFragment.arSceneView.scene.setOnUpdateListener(::onFrame)
        ...
        ModelRenderable.builder()
                ...
                .exceptionally { throwable ->
                    val toast = Toast.makeText(this, "Unable to load test model renderable", Toast.LENGTH_LONG)
