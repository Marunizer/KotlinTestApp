...
class RotatingNode : Node(), Node.OnTapListener {
    ...
    private var isItAnimatedByUser: Boolean = true
    ...
    fun isAnimatedByUser() : Boolean {
        return isItAnimatedByUser
    }

    fun setAnimated(truth : Boolean){
        this.isItAnimatedByUser = truth
    }
