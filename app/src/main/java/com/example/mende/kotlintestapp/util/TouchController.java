...
//
//	public TouchController(SceneView view, Node renderer) {
//		super();
//		this.view = view;
...
//		}
//
//		//TODO: Add a simple callback to turn of or on the rotation
...
//			Camera camera = view.getScene().getCamera();
...
//		}
//
//	//	view.getRenderer().getSurfaceView().request;requestRender();
//
//		return true;
//
//	}
